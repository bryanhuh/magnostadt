         ...
         */}
            ...
            <div className="relative z-10 w-full h-full max-w-[1600px] mx-auto px-4 md:px-8 flex flex-col justify-center h-full">
                 ...
                 */}
                        ...
                        {/* Floating Products (Only Show on md+) */}
                        {products.length > 0 && (
                            <div className="absolute bottom-20 right-10 md:right-0 z-20 hidden md:flex gap-4 md:gap-[calc(-3rem)]">
                                ...
                                `}
                                    >
                                        ...
                                        <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-black via-black/80 to-transparent">
                                            ...
                                            <p className="text-[#F0E6CA] text-xs font-bold font-exo-2">{formatPrice(Number(product.price))}</p>
                                        </div>
                                    </Link>
                                ))}
                            </div>
