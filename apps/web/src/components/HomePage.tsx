...
export function HomePage() {
  ...
  return (
    <div className="space-y-20 pb-20">
      ...
      {/* 3. Pre-order Showcase (Top Anime + Preorders) */}
      ...
      {/* 5. Shop Figures and Manga (Grid) */}
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="relative h-[400px] group overflow-hidden rounded-3xl bg-gray-900 border border-gray-800">
          <div className="absolute inset-0 bg-gradient-to-t from-gray-950 via-transparent to-transparent z-10" />
           ...
           <div className="absolute bottom-0 left-0 p-8 z-20">
             ...
             <Link 
               to="/?category=figures"
               className="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-black px-6 py-3 rounded-xl font-bold uppercase tracking-wider transition-colors"
             >
        ...
        <div className="relative h-[400px] group overflow-hidden rounded-3xl bg-gray-900 border border-gray-800">
          <div className="absolute inset-0 bg-gradient-to-t from-gray-950 via-transparent to-transparent z-10" />
           ...
           <div className="absolute bottom-0 left-0 p-8 z-20">
             ...
             <Link 
                to="/?category=manga"
                className="inline-flex items-center gap-2 bg-white text-black hover:bg-gray-200 px-6 py-3 rounded-xl font-bold uppercase tracking-wider transition-colors"
             >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {seriesList?.map((anime) => (
            <Link 
              key={anime.id} 
              to={`/?animeId=${anime.id}`}
              className="group flex flex-col items-center text-center gap-3 p-4 rounded-xl hover:bg-gray-900 transition-colors"
            >
